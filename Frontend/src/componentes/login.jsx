  ...
  return (
    <div className="text-gray-900 min-h-screen flex flex-col justify-between" style={{ backgroundColor: "#E3F2FD" }}>
      ...
      <div className="flex justify-center py-6 bg-white shadow-md">
        <Link to="/">
          <img src="/logo.png" alt="Logo" className="w-24 h-24 rounded-full object-cover cursor-pointer" />
        </Link>
      </div>
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-12">
        <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-[#1A73E8] text-white py-2 px-4 rounded-lg font-semibold shadow-md hover:bg-blue-600 transition">
              Iniciar Sesión
            </button>
          </form>
        </div>
      ...
      {/* WHATSAPP */}
      <a href="https://api.whatsapp.com/send?phone=3123586505" target="_blank" rel="noopener noreferrer"
